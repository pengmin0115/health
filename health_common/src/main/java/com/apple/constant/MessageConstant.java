...
public class MessageConstant {
    ...
    public static final String DELETE_CHECKITEM_FAIL2 = "检查项和中间表存在关联,不可删除";
    ...
    public static final String DELETE_CHECKGROUP_FAIL2 = "检查组有关联的检查项,不可删除";
    ...
    public static final String UPDATE_SETMEAL_FAIL = "更新套餐失败";
    public static final String UPDATE_SETMEAL_SUCCESS = "更新套餐成功";
    public static final String DELETE_SETMEAL_FAIL = "删除套餐失败";
    public static final String DELETE_SETMEAL_FAIL2 = "套餐和检查组中间表存在关系,不可删除";
    ...
    public static final String ORDERSETTING_FAIL_ORDERDATE = "预约设置失败,所选日期不可预约";
    public static final String ORDERSETTING_FAIL_OVERMAXNUM = "预约设置失败,所选日期已约满";
    ...
    public static final String EXPORT_BUSINESS_REPORT_FAIL = "导出运营数据失败";
    public static final String EXPORT_BUSINESS_REPORT_SUCCESS = "导出运营数据成功";
